...
void myWindNinjakEpsilon<BasicMomentumTransportModel>::correctNut()
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix> myWindNinjakEpsilon<BasicMomentumTransportModel>::kSource() const
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix> myWindNinjakEpsilon<BasicMomentumTransportModel>::epsilonSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
...
template<class BasicMomentumTransportModel>
myWindNinjakEpsilon<BasicMomentumTransportModel>::myWindNinjakEpsilon
(
...
myWindNinjakEpsilon<BasicMomentumTransportModel>::divDevTau
(
    volVectorField& U
) const
{
...
template<class BasicMomentumTransportModel>
bool myWindNinjakEpsilon<BasicMomentumTransportModel>::read()
{
...
template<class BasicMomentumTransportModel>
void myWindNinjakEpsilon<BasicMomentumTransportModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
